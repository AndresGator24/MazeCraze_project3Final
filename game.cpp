...
//draws destination at its position
void Game::DrawDestination(sf::RenderWindow& window) {
    gameBoard->squares[destSquare].red = true;
}

//determines whether or not the player can move and moves them
...
//calls relevant functions to show the path
...
//bfs borrowed from maze analysis
...
//also borrowed from maze analysis
...
//handles all textures for this mode
...
//processed the keyboard presses
...
//assigns positions for start and end
