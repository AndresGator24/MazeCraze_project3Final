...
// Draw text and draw the square vector
...
// Track to see if a game mode has been chosen
...
void HomeScreen::setText() {
    ...
    GameModeText.setPosition(titleText.getPosition().x , titleText.getPosition().y + 120);
    ...
    MazeAnalysisText.setPosition(titleText.getPosition().x , titleText.getPosition().y + 220);
...
void HomeScreen::initializeSquares() {
    ...
    // A for loop adds squares on the right, left, upper and lower parts of the screen 
    string color = "white";
    int numSquare = 0;
    ...
    // Start the clock to control color alternation
    start = high_resolution_clock::now();

}

// Squares are alternated from white to black and vice versa.
